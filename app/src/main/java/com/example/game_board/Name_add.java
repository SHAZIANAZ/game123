...
public class Name_add extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button submitName = (Button) findViewById (R.id.button);
        ...
        submitName.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                if (editText1.isEmpty ()) {
                    ...
                    Intent intent = new Intent ( Name_add.this, MainActivity.class );

                    intent.putExtra ("player1",editText);

                    startActivity( intent );

                    Intent intent2 = new Intent ( Name_add.this, MainActivity.class );
